...
%
% Open Simulink model.
mdl = './models/RandomizedBlendingCarControl';
%open_system(mdl)
...
%Ts = 0.1;
%HumanMPC= mpc(vehicle,Ts);
%ASMPC= mpc(vehicle,Ts);
%%
...
%HumanMPC.MV.RateMin = -0.26;
%HumanMPC.MV.RateMax = 0.26;
%ASMPC.MV.RateMin = -0.26;
%ASMPC.MV.RateMax = 0.26;
%%
...
%HumanMPC.Weights.OV = [1 1];                            
%ASMPC.Weights.OV = [1 0.1];    
%% Simulation Analysis
